...
<body>
    ...
    <div class="row col-sm-12">
        <div class="col-sm-8">
            <img id="jett" src="img/jett/Jett.png" class="mx-auto d-block img-sm">
        </div>
        <div class="col-sm-2"><br>
            <div class="text-right" style="color: white; margin-left: -60%;">
                ...
                <h2>DUELISTA</h2><br>
                <b>//BIOGRAFIA</b><br><br>
                <b>Jett viene de Corea del Sur, y su estilo de lucha ágil y
                    evasivo le permite
                    asumir grandes riesgos.
                    Corre y salta de aquí para allá en las refriegas y hace trizas a los enemigos con una rapidez
                    espectacular.</b>
            </div>
        </div>
    </div>
    <div class="container">
        <button onclick="playVideo('videojett2')">
            <img class="mi-imagen" src="img/jett/Q.png">
        </button>
        <button onclick="playVideo('videojett3')">
            <img class="mi-imagen" src="img/jett/E.png" alt="">

        </button>
        <button onclick="playVideo('videojett1')">
            <img class="mi-imagen" src="img/jett/C.png" alt="">

        </button>
        <button onclick="playVideo('videojett4')">
