...
<body class="bg-secondary">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="menu">
        <ul class="navbar-nav me-auto"> <!-- Agregamos la clase "ms-auto" -->
          ...
          <li class="nav-item">
            <a class="nav-link active" href="admin/administracion.php">Administracion</a>
          </li>
          <li class="nav-item">
  ...
  <div class="first card">
    ...
    <div class="card_btn">
      <a href="agentes/jett.php">Mas Información</a>
    </div>
  </div>
  ...
  <div class="second card">
    ...
    <div class="card_btn">
      <a href="agentes/neon.php">Mas Información</a>
    </div>
  </div>
  <div class="first card">
